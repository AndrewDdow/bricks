...
class Match {
	...
	public Match() {
		...
		_lib = new Image[4];
		_lib[0] = _pf.getToolkit().getImage(Match.class.getResource("puck.gif"));
		_lib[1] = _pf.getToolkit().getImage(Match.class.getResource("puddle.gif"));
		_lib[2] = _pf.getToolkit().getImage(Match.class.getResource("brick.gif"));
                _lib[3] = _pf.getToolkit().getImage(Match.class.getResource("hardbrick.gif"));
